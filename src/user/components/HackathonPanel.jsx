    ...
    const mockSubmissions = [
      {
        ...
        status: 'submitted',
        score: 85,
        feedback: 'Great implementation of the core features. Consider adding more error handling.',
      ...
      },
      {
        ...
        status: 'evaluated',
        score: 92,
        feedback: 'Excellent work! Your solution was innovative and well-documented.',
    ...
    try {
      ...
      const mockHackathons = [
        ...
        },
        {
          ...
          timeRemaining: '45 days until start',
        ...
        },
        {
          ...
          description: 'Create a tool that generates developer portfolios',
          prize: '$750',
          deadline: '2023-12-05',
          participants: 15,
          difficulty: 'Intermediate',
